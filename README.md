# bert-chinese-classification-gradio
中文文本分类，Bert，ERNIE，基于pytorch，gradio网页交互，开箱即用。

## 介绍
模型介绍、数据流动过程(还没写)。

机器：一块3060laptop ， 训练时间：3个小时。  
...
## 中文数据集
[THUCNews](http://thuctc.thunlp.org/)中抽取了20万条新闻标题，已上传至github，文本长度在20到30之间。一共10个类别，每类2万条。数据以字为单位输入模型。
